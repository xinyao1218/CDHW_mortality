...
folder_path = 'C:\Users\yaoxin\Desktop\Mortality_CDHW_olderadults_China\data\HW_index_yearly';


frequency_ssp126_info = dir(fullfile(folder_path, '*frequency_92_ssp126.nc'));
frequency_ssp126_names = {frequency_ssp126_info.name};
frequency_ssp126_paths = fullfile(folder_path, frequency_ssp126_names);

frequency_ssp370_info = dir(fullfile(folder_path, '*frequency_92_ssp370.nc'));
frequency_ssp370_names = {frequency_ssp370_info.name};
frequency_ssp370_paths = fullfile(folder_path, frequency_ssp370_names);

frequency_ssp585_info = dir(fullfile(folder_path, '*frequency_92_ssp585.nc'));
...
hold on
plot([1985.1 1992.1],[5.35/6*y_limits(2) 5.35/6*y_limits(2)],'color', [0.18039, 0.5451, 0.34118], 'LineWidth', 4)
hold on
...
text(1992.6,5.35/6*y_limits(2),'SSP1-2.6*', 'color', [0.18039, 0.5451, 0.34118],'FontSize', 30, 'FontName', 'Times New Roman')
...
title('Heatwave', 'FontSize', 60, 'FontWeight', 'bold', 'FontName', 'Times New Roman')
dpi = 300;  
print(gcf, 'C:\Users\yaoxin\Desktop\Mortality_CDHW_olderadults_China\figure\sf_DHW_trend\HW_frequency.jpg', '-djpeg', ['-r', num2str(dpi)]);
...
ax.YAxis.FontSize = 30;  
xlabel('Year', 'FontSize', 60, 'FontWeight', 'bold', 'FontName', 'Times New Roman');
ylabel('Duration (days per year)', 'FontSize', 60, 'FontWeight', 'bold', 'FontName', 'Times New Roman');
title('Heatwave', 'FontSize', 60, 'FontWeight', 'bold', 'FontName', 'Times New Roman')
dpi = 300;  
print(gcf, 'C:\Users\yaoxin\Desktop\Mortality_CDHW_olderadults_China\figure\sf_DHW_trend\HW_duration.jpg', '-djpeg', ['-r', num2str(dpi)]);
...
title('Heatwave', 'FontSize', 60, 'FontWeight', 'bold', 'FontName', 'Times New Roman')
dpi = 300;  
print(gcf, 'C:\Users\yaoxin\Desktop\Mortality_CDHW_olderadults_China\figure\sf_DHW_trend\HW_severity.jpg', '-djpeg', ['-r', num2str(dpi)]);
