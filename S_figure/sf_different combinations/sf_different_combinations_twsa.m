...
severity_ssp126_info = dir(fullfile(folder_path, '*severity_99_twsa_2_ssp126.nc'));
severity_ssp126_names = {severity_ssp126_info.name};
severity_ssp126_paths = fullfile(folder_path, severity_ssp126_names);

severity_ssp370_info = dir(fullfile(folder_path, '*severity_99_twsa_2_ssp370.nc'));
severity_ssp370_names = {severity_ssp370_info.name};
severity_ssp370_paths = fullfile(folder_path, severity_ssp370_names);

severity_ssp585_info = dir(fullfile(folder_path, '*severity_99_twsa_2_ssp585.nc'));
...
title('Compound drought and heatwave (99th-2 days-TWSA)', 'FontSize', 60, 'FontWeight', 'bold', 'FontName', 'Times New Roman')
dpi = 300;  
print(gcf, 'C:\Users\yaoxin\Desktop\Mortality_CDHW_olderadults_China\figure\sf_different combinations\CDHW_frequency_99_2_twsa.jpg', '-djpeg', ['-r', num2str(dpi)]);
...
title('Compound drought and heatwave (99th-2 days-TWSA)', 'FontSize', 60, 'FontWeight', 'bold', 'FontName', 'Times New Roman')
dpi = 300;  
print(gcf, 'C:\Users\yaoxin\Desktop\Mortality_CDHW_olderadults_China\figure\sf_different combinations\CDHW_duration_99_2_twsa.jpg', '-djpeg', ['-r', num2str(dpi)]);
...
title('Compound drought and heatwave (99th-2 days-TWSA)', 'FontSize', 60, 'FontWeight', 'bold', 'FontName', 'Times New Roman')
dpi = 300;  
print(gcf, 'C:\Users\yaoxin\Desktop\Mortality_CDHW_olderadults_China\figure\sf_different combinations\CDHW_severity_99_2_twsa.jpg', '-djpeg', ['-r', num2str(dpi)]);
