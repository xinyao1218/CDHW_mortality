...
title('Compound drought and heatwave', 'FontSize', 60, 'FontWeight', 'bold', 'FontName', 'Times New Roman')
dpi = 300;  
print(gcf, 'C:\Users\yaoxin\Desktop\Mortality_CDHW_olderadults_China\figure\fig2\CDHW_frequency.jpg', '-djpeg', ['-r', num2str(dpi)]);
...
title('Compound drought and heatwave', 'FontSize', 60, 'FontWeight', 'bold', 'FontName', 'Times New Roman')
dpi = 300;  
print(gcf, 'C:\Users\yaoxin\Desktop\Mortality_CDHW_olderadults_China\figure\fig2\CDHW_duration.jpg', '-djpeg', ['-r', num2str(dpi)]);
...
title('Compound drought and heatwave', 'FontSize', 60, 'FontWeight', 'bold', 'FontName', 'Times New Roman')
dpi = 300;  
print(gcf, 'C:\Users\yaoxin\Desktop\Mortality_CDHW_olderadults_China\figure\fig2\CDHW_severity.jpg', '-djpeg', ['-r', num2str(dpi)]);
